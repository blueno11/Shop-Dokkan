...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Đăng nhập thành công, không cần lưu token, session đã lưu ở cookie
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-gray-900 border-gray-700 shadow-2xl">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold text-white mb-2">Đăng nhập</CardTitle>
            <p className="text-gray-400">Đăng nhập vào tài khoản Dokkan Shop của bạn</p>
          </CardHeader>
        ...
        <div className="mt-6 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
          <p className="text-gray-400 text-sm text-center mb-2">
            <strong className="text-orange-400">Demo:</strong> Sử dụng thông tin sau để đăng nhập
          </p>
